...
export const LinkedInIcon = ({className, ...rest}) => (
 ...
 export const GithubIcon = ({className, ...rest}) => (
  <svg
    ...
    height="1.5em"
    aria-hidden="true"
    className={`octicon w-full h-auto octicon-mark-github ${className} ` }
    viewBox="0 0 16 16"
    {...rest}
  >
    <path
...
export const InstagramIcon = ({className, ...rest}) => (
      <svg xmlns="http://www.w3.org/100/svg" width="1.8em"  height="1.8em"  viewBox="0 0 128 100"  className={` ${className}`} {...rest}>
        <defs>
          <radialGradient
            id="a"
            cx={6.601}
